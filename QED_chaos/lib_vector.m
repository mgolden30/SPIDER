...
labels{a} = "\partial_t E_i";
G(x,a)    = SPIDER_integrate( Es(:,:,:,1), [3], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( Es(:,:,:,2), [3], grid, corners, size_vec, pol );
scales(a) = std_E/T;
a         = a+1;
...
labels{a} = "\nabla^2 A_i";
G(x,a)    = SPIDER_integrate( As(:,:,:,1), [1,1], grid, corners, size_vec, pol ) + ...
            SPIDER_integrate( As(:,:,:,1), [2,2], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( As(:,:,:,2), [1,1], grid, corners, size_vec, pol ) + ...
            SPIDER_integrate( As(:,:,:,2), [2,2], grid, corners, size_vec, pol );
scales(a) = std_A/L/L;
a         = a+1;

labels{a} = "\nabla^2 E_i";
G(x,a)    = SPIDER_integrate( Es(:,:,:,1), [1,1], grid, corners, size_vec, pol ) + ...
            SPIDER_integrate( Es(:,:,:,1), [2,2], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( Es(:,:,:,2), [1,1], grid, corners, size_vec, pol ) + ...
            SPIDER_integrate( Es(:,:,:,2), [2,2], grid, corners, size_vec, pol );
scales(a) = std_E/L/L;
a         = a+1;

labels{a} = "\nabla_i \rho";
G(x,a)    = SPIDER_integrate( rho, [1], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( rho, [2], grid, corners, size_vec, pol );
scales(a) = std_rho/L;
a         = a+1;

labels{a} = "\nabla_i \phi";
G(x,a)    = SPIDER_integrate( phi, [1], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( phi, [2], grid, corners, size_vec, pol );
scales(a) = std_phi/L;
a         = a+1;

labels{a} = "j^i";
G(x,a)    = SPIDER_integrate( J(:,:,:,1), [], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( J(:,:,:,2), [], grid, corners, size_vec, pol );
scales(a) = mean_J;
a         = a+1;

labels{a} = "\partial_t j^i";
G(x,a)    = SPIDER_integrate( J(:,:,:,1), [3], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( J(:,:,:,2), [3], grid, corners, size_vec, pol );
scales(a) = std_J/T;
a         = a+1;

labels{a} = "\rho E^i";
rhoE = rho.*Es;
G(x,a)    = SPIDER_integrate( rhoE(:,:,:,1), [], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( rhoE(:,:,:,2), [], grid, corners, size_vec, pol );
scales(a) = mean_rho*mean_E;
a         = a+1;

labels{a} = "\phi j^i";
phiJ = rho.*J;
G(x,a)    = SPIDER_integrate( phiJ(:,:,:,1), [], grid, corners, size_vec, pol );
G(y,a)    = SPIDER_integrate( phiJ(:,:,:,2), [], grid, corners, size_vec, pol );
scales(a) = mean_phi*mean_J;
a         = a+1;
