...
Ms = [128, 256, 512, 1024, 2048, 4096, 2^13, 2^14, 2^15, 2^16, 2^17, 2^18, 2^19, 2^20];
...
size_vec                = [round(x_per_subdomain/2/pi*N), round(t_per_subdomain/T*Ms(sweep_idx))]; %how many gridpoints should we use per integration?
...
save("seed_" + seed + "_M_" + M + ".mat", "G", "labels", "scales");
end
end